    ...
    >
      ...
      >
        ...
        <!--  -->
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--dl-color-primary-50)" class="absolute bottom-0 right-0 z-0 h-[100%] w-auto">
          ...
          <div class="flex flex-col items-start justify-center">
            <button class="flex flex-col pl-3">
              ...
              <p class="text-[16px] font-normal justify-start items-center gap-2 inline-flex">
